import { Connection, SystemProgram, Transaction, sendAndConfirmTransaction, clusterApiUrl, Keypair } from "@solana/web3.js";
import fs from "fs";
...
const createAccountTransaction = new Transaction().add(SystemProgram.createAccount({
